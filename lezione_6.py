...
# chiudo il file a fine operazioni: si crea file text.txt
file_testo.close()
...
# visualizzo il contenuto letto dal file: stampa ciò che ha letto
print(contenuto)
...
# Apro un file binario in scrittura: e scrivo i caratteri binari (wb)
